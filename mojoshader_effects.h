...
typedef enum MOJOSHADER_samplerStateType
{
    ...
    MOJOSHADER_SAMP_TEXTURE       = 3,
    MOJOSHADER_SAMP_ADDRESSU      = 4,
    MOJOSHADER_SAMP_ADDRESSV      = 5,
    MOJOSHADER_SAMP_ADDRESSW      = 6,
    MOJOSHADER_SAMP_BORDERCOLOR   = 7,
    MOJOSHADER_SAMP_MAGFILTER     = 8,
    MOJOSHADER_SAMP_MINFILTER     = 9,
    MOJOSHADER_SAMP_MIPFILTER     = 10,
    MOJOSHADER_SAMP_MIPMAPLODBIAS = 11,
    MOJOSHADER_SAMP_MAXMIPLEVEL   = 12,
    MOJOSHADER_SAMP_MAXANISOTROPY = 13,
    MOJOSHADER_SAMP_SRGBTEXTURE   = 14,
    MOJOSHADER_SAMP_ELEMENTINDEX  = 15,
    MOJOSHADER_SAMP_DMAPOFFSET    = 16
